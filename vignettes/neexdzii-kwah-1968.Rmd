...
dropped even if it's 15 ha. Network-aware pruning that snaps polygons to the
stream network and prunes based on connectivity rather than area alone would
